...
//    var file1 = File("$tempPath/file.pdf");
//    await file1.writeAsBytes(pdf.save());
  }
}
...
//
//  ModelDownloadPDF model = ModelDownloadPDF();
//
...
//      model.id_konsul = model.dataKonsul[0]['id_konsultasi'];
//
//      filePath = 'http://10.0.2.2/skripsi_gingivitis/downloadPDF.php?iduser=${model.id}&idkonsul=${model.id_konsul}';
//
//      print("id konsul adalah : ${model.id_konsul}");
//
//    });
//
