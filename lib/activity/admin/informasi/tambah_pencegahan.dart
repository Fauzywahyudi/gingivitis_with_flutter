...
class TambahPencegahan extends StatefulWidget {
  @override
  _TambahPencegahanState createState() => _TambahPencegahanState();
}

class _TambahPencegahanState extends State<TambahPencegahan> {

  ModelminTambahPencegahan model = ModelminTambahPencegahan();

  Future<int> tambah()async{
    
    final result = await http.post(link.LinkSource.addPencegahan,body: {
